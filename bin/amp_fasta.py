...
#Filter assembly faa for contigs of interest (summary_df) and save to out_name.faa
# return path to out_name.faa as input for taxonomic analysis 
def amp_fasta(summary_df, faa, out_name):
    ...
    with open(out_name, 'w') as out_file:
        for faa in faa_sequences:
            ...
            for contig in arg_contigs:
                if (id==contig):
                    out_file.write('>'+ id + '\n' + sequence + '\n')
    return out_name # path for input to Diamond, MMSeq