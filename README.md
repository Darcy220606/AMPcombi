...
To get a full list of options available and their defaults please please refer to the help documentation of teh submodule
...
- **--contig_metadata** a `*.tsv` file that mjust contain the sample name in teh first column and the contig ID/name in the second column. The column headers are not important.
